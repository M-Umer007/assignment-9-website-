  ...
  return (
    <div className="p-4">
      ...
      <div className="flex flex-wrap gap-4 mb-4">
        <div className="flex-1 min-w-[300px] bg-gray-100 border border-black p-4 rounded-md shadow">
      ...
      <div className="flex flex-wrap gap-4">
        <div className="flex-1 min-w-[200px] bg-gray-100 border border-black p-4 rounded-md shadow">
